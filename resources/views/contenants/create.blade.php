...
@section('title', 'Créer un prix standard')

@section('content')
<div class="content-wrapper">
  <div class="container-xxl flex-grow-1 container-p-y">
    <div class="d-flex justify-content-between align-items-center mb-4">
      <h4 class="mb-0">Créer un prix standard</h4>
      <a href="{{ route('admin.contenants.index') }}" class="btn btn-outline-secondary">Retour</a>
    </div>

    <div class="card">
      <div class="card-body">
        <form method="POST" action="{{ route('admin.contenants.store') }}">
          @csrf

          <div class="mb-3">
            <label class="form-label" for="ml">ML</label>
            <input type="number" id="ml" name="ml" value="{{ old('ml') }}" class="form-control @error('ml') is-invalid @enderror" min="1" required>
            @error('ml')
          ...
          <div class="mb-3">
            ...
            <input type="text" id="type_contenant" name="type_contenant" value="{{ old('type_contenant') }}" class="form-control @error('type_contenant') is-invalid @enderror" maxlength="100" required>
