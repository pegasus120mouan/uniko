        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bold ms-2">Uniko Perfume</span>
            </a>
              ...
              <ul class="menu-sub">
                <li class="menu-item active">
                  <a href="{{ route('dashboard') }}" class="menu-link">
                    <div class="text-truncate" data-i18n="Analytics">Vue d'ensemble</div>
                  </a>
                </li>
              </ul>
            </li>
            ...
            @if (auth()->check() && auth()->user()->role === 'admin')
              <li class="menu-item">
                <a href="javascript:void(0);" class="menu-link menu-toggle">
                  ...
                  <div class="text-truncate" data-i18n="Layouts">Gestion</div>
                </a>
                ...
                <ul class="menu-sub">
                  ...
                  <li class="menu-item">
                    <a href="{{ route('admin.sales.index') }}" class="menu-link">
                      <div class="text-truncate">Ventes</div>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a href="{{ route('admin.reports.sales') }}" class="menu-link">
                      <div class="text-truncate">Rapport ventes</div>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a href="{{ route('admin.stock.alerts') }}" class="menu-link">
                      <div class="text-truncate">Alertes stock</div>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a href="{{ route('admin.stock.movements') }}" class="menu-link">
                      <div class="text-truncate">Mouvements de stock</div>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a href="{{ route('admin.reports.inventory') }}" class="menu-link">
                      <div class="text-truncate">Rapport inventaire</div>
                    </a>
                  </li>
                  <li class="menu-item">
                    <a href="{{ route('admin.reports.revenue') }}" class="menu-link">
                      <div class="text-truncate">Statistiques CA</div>
                    </a>
                  </li>
                </ul>
              </li>
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1">
                            <h6 class="mb-0">{{ auth()->check() ? auth()->user()->name : 'Invité' }}</h6>
                            <small class="text-body-secondary">{{ auth()->check() ? auth()->user()->role : '' }}</small>
                          </div>
                        </div>
                      </a>
                    </li>
